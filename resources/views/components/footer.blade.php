<div class="uk-width-1-1 footer">
  <div class="uk-container uk-container-center uk-margin-large-bottom">
                 ...
                 {{-- <li><a href="#" class="uk-icon-justify uk-icon-large uk-icon-snapchat-ghost"></a></li>--}}
                  {{--<li><a href="{{action('PostController@feed')}}" class="uk-icon-justify uk-icon-large uk-icon-rss"></a></li>--}}
              </ul>
                      
                           <p class="uk-text-small uk-text-muted" >&copy; Vine &amp; Cate Ltd. 2016{{-- - <a class="uk-link-muted" href="{{url('legal')}}">Legal</a>--}}</p>
